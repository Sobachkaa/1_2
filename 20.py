...
eng_scores = {'A': 1, 'B': 3, 'C': 3, 'D': 2, 'E': 1, 'F': 4, 'G': 2, 'H': 4,
              'I': 1, 'J': 8, 'K': 5, 'L': 1, 'M': 3, 'N': 1, 'O': 1, 'P': 3,
              'Q': 10, 'R': 1, 'S': 1, 'T': 1, 'U': 1, 'V': 4, 'W': 4, 'X': 8,
              'Y': 4, 'Z': 10}

rus_scores = {'А': 1, 'Б': 3, 'В': 1, 'Г': 3, 'Д': 2, 'Е': 1, 'Ё': 3, 'Ж': 5,
...
if word.isalpha():  # проверяем, что в слове только буквы
    if word[0] in eng_scores:  # если первая буква английская
        for letter in word:
            score += eng_scores[letter]
    elif word[0] in rus_scores:  # если первая буква русская
        for letter in word:
            score += rus_scores[letter]
    else:
        print("Ошибка: некорректная буква")
else:
